...
- **SOLUÇÃO:**
  ...
  - blind_annotator.py: CSV cego v2 — youtube_channel_url + channel_bio (descrição + links da aba Sobre)
    - Fallback por artist_name para channel_id mismatches (Anitta, etc.)
    - 91/91 com links, 56/91 com Spotify na bio
  - excel_formatter.py: Excel formatado (.xlsx) com cores, dropdowns, freeze panes, aba README
